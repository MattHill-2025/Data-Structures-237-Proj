...
/** \file term.cpp
 * \brief The function implementation of the Term class
 */
...
{       /*********************************************************************
        ...
        *   Parameters: ofstream &ouput - const Term &t- the term object to be outputted
        *
        *   Return Value: output
        *********************************************************************/
...
{       /*********************************************************************
        ...
        *   Description:  Compares two Terms based on exponent
        *   Parameters: const Term right- term that it gets compared to.
        *
        *   Return Value: according to the comparison
        *********************************************************************/
        return(getExponent() > right.getExponent());
...
{       /*********************************************************************
        *   Function name:  operator!=
        *   Description:  Compares an int against the exponent
        *   Parameters: const Term right - term that gets compared to.
        *
        *   Return Value: true- if not a match // false- if it matches
        *********************************************************************/
        return(getExponent()!= right.getExponent());
}